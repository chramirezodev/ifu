...
const Politicas = () => (
  <>
    <Head>
      ...
      <meta name="description" content="Lee nuestras políticas de uso y privacidad. Mardini Law Firm protege tu información y explica cómo usamos tus datos." />
    </Head>
    <main className="py-16 bg-white min-h-screen">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <p className="mb-4">En Mardini Law Firm, nos comprometemos a proteger tu privacidad. Para conocer más detalles sobre el uso de tus datos, consulta nuestro <a href="/aviso-legal" className="text-usa-blue underline">AVISO LEGAL</a>.</p>
