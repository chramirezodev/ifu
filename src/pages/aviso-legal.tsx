...
const AvisoLegal = () => (
  <>
    <Head>
      ...
      <meta name="description" content="Aviso legal y condiciones de uso del sitio web de Mardini Law Firm." />
    </Head>
