...
const LegalNoticeEn = () => (
  <>
    <Head>
      <title>Legal Notice | Immigration For US</title>
      <meta name="description" content="Legal notice and terms of use for Immigration For US website." />
    </Head>
    <main className="py-16 bg-white min-h-screen">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <p className="mb-4">You understand that this website is owned by Immigration For US, including all intellectual and industrial property rights derived from or included in it, and you have no right to use them except as set forth in these Terms of Use. We reserve the right to deny or terminate your access to the Website at our discretion.</p>
