    ...
    <section id="por-que-elegirnos" className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {homeWhyChooseUs.reasons.map((reason, index) => (
            <ReasonCard
              key={index}
              icon={iconMap[reason.iconKey || 'experience'] || iconMap.experience}
              title={reason.title}
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="p-8 text-center">
                  <h3 className="text-3xl font-bold text-white mb-4 drop-shadow-md">
                    {homeWhyChooseUs.bannerTitle}
                  </h3>
                  <p className="text-white text-lg drop-shadow-sm">{homeWhyChooseUs.bannerSubtitle}</p>
                </div>
              </div>
            </div>
